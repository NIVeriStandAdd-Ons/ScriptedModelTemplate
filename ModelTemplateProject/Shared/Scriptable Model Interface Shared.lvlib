...
<Library LVVersion="14008000">
	...
	<Item Name="Shared" Type="Folder">
		<Item Name="Types" Type="Folder">
			<Item Name="channel id.ctl" Type="VI" URL="../channel id.ctl"/>
			<Item Name="model inputs.ctl" Type="VI" URL="../model inputs.ctl"/>
			<Item Name="model outputs.ctl" Type="VI" URL="../model outputs.ctl"/>
			<Item Name="model parameters.ctl" Type="VI" URL="../model parameters.ctl"/>
			<Item Name="simple data type.ctl" Type="VI" URL="../simple data type.ctl"/>
		</Item>
